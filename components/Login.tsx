...
const Login = () => {
    return (
        <div className="w-full h-screen bg-black flex justify-center items-center bg-cover bg-center bg-[url('/background.png')] gap-10 overflow-hidden show-scroll-bar-when-short">
            <div className="relative flex justify-center items-center w-[50%] h-full hidden lg:block hide-when-short">
                ...
                <h1
                    ...
                    bg-gradient-to-r from-yellow-300 from-[5%] via-orange-400 via-[25%] via-pink-500 via-[55%] to-fuchsia-600 to-[90%]
                    font-extrabold text-6xl leading-tight tracking-wide 
